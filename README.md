# Commodore 8-bit Computing `(/commodore-8bit)`
...
It also aims to show the relationships between the hardware design, the BASIC command line interface and interpeter, raw machine code, machine language monitor programs, assembly language and areas of overlap where improving one's knowledge of one topic leads to an advantage in the others.
